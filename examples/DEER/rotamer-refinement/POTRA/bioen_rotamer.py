...
def plot_deer_traces(bioen_data):
    ...
    def plot_traces(ident_all, idx):
        ...
        theta = 1000.0
#         print(label_id)
#         print(bioen_data.keys())
        theta_max = np.max(list(bioen_data[label_id].keys()))
        label_lst = list(bioen_data[label_id][theta]['exp']['deer'].keys())
        label = label_lst[0]
#         print(list(bioen_data[label_id][theta]['exp']['deer'].keys()))
...
def plot_reweighted_elbow(bioen_data):
    ...
    def plot_traces(ident_all, idx):
        ...
        theta = 1000.0
        theta_max = np.max(list(bioen_data[label_id].keys()))
        label = list(bioen_data[label_id][thetas[0]]['exp']['deer'].keys())[0]
        npoints = len(bioen_data[label_id][theta]['exp']['deer'][label][:,0])
